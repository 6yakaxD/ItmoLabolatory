...
public class insert extends ACommand
{
    ...
    public boolean launch(String[] command)
    {
        if(command.length == 2)
        {
            ...
            System.out.print("Do you agree to save it to a SpaceMarine Collection? [Y/N]");
            String save_to_collection = scanner.nextLine();
            if (save_to_collection.equalsIgnoreCase("Y") || save_to_collection.equalsIgnoreCase("Yes") || save_to_collection.equals("+") || save_to_collection.equals("Da"))
            {
